...
const I18N = {
  en: {
    ...
    selectOptions: {
      ...
      sq2: [
        { value: "0", label: "0-14 pack-years" },
        { value: "1", label: "15-30 pack-years" },
        { value: "2", label: ">=30 pack-years" },
      ],
      sq3: [
        { value: "7", label: "BMI <18.5 kg/m²" },
        { value: "4", label: "BMI 18.5-23.9 kg/m²" },
        { value: "1", label: "BMI 24.0-27.9 kg/m²" },
        { value: "0", label: "BMI >=28.0 kg/m²" },
      ],
      sq5: [
        { value: "0", label: "No dyspnea" },
        { value: "2", label: "Dyspnea when hurrying/climbing slight hill" },
        { value: "3", label: "Dyspnea while normal walking on level ground" },
      ],
      ps5: [
        { value: "0", label: "Strongly disagree / Disagree / Unsure" },
        { value: "1", label: "Agree" },
  ...
  zh: {
    ...
    selectOptions: {
      ...
      sq2: [
        { value: "0", label: "0~14 包•年" },
        { value: "1", label: "15~30 包•年" },
        { value: "2", label: ">=30 包•年" },
      ],
      sq3: [
        { value: "7", label: "BMI <18.5 kg/m²" },
        { value: "4", label: "BMI 18.5~23.9 kg/m²" },
      ...
      sq5: [
        { value: "0", label: "没有气促" },
        { value: "2", label: "平地急行或爬小坡时气促" },
        { value: "3", label: "平地正常行走时气促" },
      ],
      ps5: [
        { value: "0", label: "强烈反对/反对/不确定" },
        { value: "1", label: "同意" },
        { value: "2", label: "非常同意" },
      ],
    },
