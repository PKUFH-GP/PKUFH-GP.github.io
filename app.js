...
const I18N = {
  en: {
    ...
    labelSex: "Sex",
    labelAge: "Age (years)",
    labelSq2: "Smoking exposure (pack-years, sq2)",
    labelSq3: "BMI category score (sq3)",
    labelSq5: "Dyspnea status score (sq5)",
    labelPs5: "Breathing impact on activity (ps5)",
  ...
  zh: {
    ...
    labelSex: "性别",
    labelAge: "年龄（岁）",
    labelSq2: "吸烟量（包/年，sq2）",
    labelSq3: "BMI 分档评分（sq3）",
    labelSq5: "气促情况评分（sq5）",
    labelPs5: "呼吸影响活动评分（ps5）",
